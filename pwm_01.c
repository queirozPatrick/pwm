// Link wokwi: https://wokwi.com/projects/422362142211338241
...
{
    return (uint32_t)(us * 1.25f); // 1us aprox 1.25 unidades
}
...
int main()
{
    ...
    // Atraso de 5 segundos para dar tempo de abrir o monitor serial
    printf("Aguardando 5 segundos para inicializar o PWM...\n");
    sleep_ms(5000);
